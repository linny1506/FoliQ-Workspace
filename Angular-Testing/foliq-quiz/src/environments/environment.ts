// Change these constants to migrate to new base. Note, BASE_URL/BASE_ID must correspond with the PKEY
const BASE_URL = 'https://api.airtable.com/v0/appjD3ZsQFD6Lb9D7/';
const BASE_ID = 'appjD3ZsQFD6Lb9D7';
const PRIVATE_KEY = 'patOxK3aX3qlbbKpx.884c70d8d90db6e40ec31960795cb682016f5f32623916d406437f8a1e722c3b'
...
export const environment = {
    ...
    airtable: {
        privateAccessToken: PRIVATE_KEY,
        baseURL: BASE_URL,
        baseID: BASE_ID,
        userTable: {
            name: 'userTable',
